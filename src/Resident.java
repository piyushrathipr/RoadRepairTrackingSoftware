...
public class Resident extends javax.swing.JFrame {
    ...
    public Resident() {
        ...
        try {
        PreparedStatement st = conn.prepareStatement("DELETE FROM complaints WHERE locid = 1");
        st.executeUpdate();
        }
        catch(Exception e)
        {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resident.png"))); // NOI18N
        ...
        jButton1.setText("Enter a fresh Complaint");
